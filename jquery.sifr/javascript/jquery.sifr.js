		...
		this.each(function () {
			...
			embedOptions = {
				flashvars: $.extend({
					...
					textAlign: p.textAlign || ele.css('text-align').match(/left|center|right/) || 'center',
				...
				style: 'margin: 1px 0 0; position: absolute; vertical-align: text-top; text-align: center;',
